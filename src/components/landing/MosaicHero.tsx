...
export default function MosaicHero() {
  return (
    <div className="rounded-2xl p-[1.5px] bg-gradient-to-tr from-accent/70 via-accent/20 to-transparent" id="hero">
    <section className="relative overflow-hidden rounded-2xl border border-[#2A2D3A] bg-[#0B0F12] scroll-mt-24">
      ...
      <div className="absolute inset-0">
        <Image src="/hero.jpg" alt="Data hero" fill priority className="object-cover opacity-60" />
      ...
      <div className="relative px-5 sm:px-8 md:px-12 py-12 sm:py-16 md:py-24 max-w-6xl mx-auto">
        ...
        <ul className="mt-6 space-y-2 text-sm text-gray-300 max-w-2xl">
          <li>• SELECT‑only guardrails · one statement · enforced LIMIT</li>
          <li>• Schema‑aware generation · 5‑minute schema cache</li>
          <li>• 10s execution timeouts · clear, friendly errors</li>
