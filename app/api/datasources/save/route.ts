...
import { getPersistedDatasourceScope, replaceDatasourceScope } from "@/lib/datasourceScope";
...
export async function POST(req: NextRequest) {
  ...
  const previousScope = existing ? await getPersistedDatasourceScope(existing.id) : [];
